...
class feet_inches_test(unittest.TestCase):
    ...
    def test_12inches_1feet(self):
        '''Description: the function test_12inches_1feet is defined to check
            Function Arguments: self
            Return: None'''

        inches_feet = Inches_Feet(12, 1)
        res = inches_feet.inches_to_feet_check()
        self.assertEqual(res, True)

    def test_1inches_Not_1feet(self):
        '''Description: the function test_1inches_Not_1feet is defined to check
            Function Arguments: self
            Return: None'''
        inches_feet = Inches_Feet(1, 1)
        res = inches_feet.inches_to_feet_check()
        self.assertEqual(res, False)
